    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand text-white fw-bold" href="./dashboard.php">
                <i class="fas fa-hotel me-2"></i>User Portal
            </a>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./booking.php">
                            <i class="fas fa-tasks me-2"></i>Booking
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./manage_services.php">
                            <i class="fas fa-calendar-alt me-2"></i>Service
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="d-flex align-items-center">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="./profile_managemeny.php">
